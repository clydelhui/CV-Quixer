"""Seq-to-seq stacked CV-Quixer (model="quantum_stacked", ADR-0002).
    ...
    def forward(
        ...
        Returns:
            ...
            patch_trunc_loss: scalar — LCU-term leakage on the actual query
                              states, mean over positions (ADR-0002).
...
class StackedCVQuixer(BaseVisionTransformer):
    ...
    def __init__(
        ...
        # num_seq2seq_blocks (it is seq-to-one, ADR-0002).
    ...
    def forward(
        ...
        Args:
            ...
            return_states:     If True, also return ``(states, success_probs)``
                               for the **decoder-input stage** (ADR-0002): the
        ...
        if self.pooling == "quixer":
            ...
            # query stream (vacuum input, ADR-0002).
        ...
        return CVQuixerOut(
            ...
            success_probs=stage_sps if return_states else None,
        )
