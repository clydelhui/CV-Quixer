"""Tests for the seq-to-seq stacked CV-Quixer (model="quantum_stacked", ADR-0002).
...
class TestStackedConfigValidation:
    ...
    def test_zero_blocks_rejected_at_construction(self):
        ...
        # the stacked config never describes it (ADR-0002).
...
class TestAggregator:
    ...
    def test_decoder_input_width_is_heads_times_r_under_both_poolings(
        ...
        # The shared-decoder-width invariant (ADR-0002): the pre-decoder
...
class TestCanonicalModelsUnaffected:
    ...
    def test_new_fields_are_inert_for_canonical_models(
        ...
        # Varying every ADR-0002 field must not change a canonical model's
